document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Only send to backend if a specific difficulty is selected (not "All")
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // When currentDifficulty is empty string and we're showing "All" for difficulty,
      // we need to check if the activity has NO difficulty field
      if (currentDifficulty === "" && allActivities) {
        // "All" is selected - show only activities without difficulty
